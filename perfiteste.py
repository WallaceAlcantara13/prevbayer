...
# Tela inicial para nome e email
...
if st.session_state.step == 1:
    resposta = st.radio("1 - Qual a sua faixa etária?", 
    ...
    resposta = st.radio("2 - Como você definiria o seu momento de vida?",
    ...
    if st.button("Próxima"):
        pontos = {"Estou apenas arcando com as despesas e compromissos financeiros":20,
                  ...
                  "Já construí meu patrimônio, estou realizando meus sonhos e objetivos, mas ainda mantenho despesas fixas elevadas":5,
                  "Já tenho um patrimônio consolidado que considero suficiente para preservar seu estilo de vida e agora é a hora de usufruir o que tem guardado":0}[resposta]
        proxima_pergunta(pontos)

elif st.session_state.step == 3:
    resposta = st.radio("3 - Qual das alternativas melhor descreve seu conhecimento do mercado financeiro?",
    ...
    resposta = st.radio("4 - Quanto tempo pretende investir?",
                        ["0","Entre 1 e 5 anos","Entre 6 e 10 anos","Acima de 10 anos"])
    if st.button("Próxima"):
        pontos = {"0":0,"Entre 1 e 5 anos":5,"Entre 6 a 10 anos":10,"Acima de 10 anos":20}[resposta]
        proxima_pergunta(pontos)

elif st.session_state.step == 5:
    resposta = st.radio("5 - O que você faria ao ver uma queda de 10% nos seus investimentos?",
    ...
    resposta = st.radio("6 - Qual seu objetivo ao investir?",
    ...
    resposta = st.radio("7 - Você realiza algum tipo de planejamento financeiro em suas finanças pessoais?",
    ...
    resposta = st.radio("8 - Quanto você poupa em relação aos seus rendimentos mensais (salário, bônus, renda extra, etc.)?",
    ...
    resposta = st.radio("9 - Além do Plano de Previdência, você tem ou pretende ter outros investimentos?",
                        ["Não, somente o plano",
    ...
    resposta = st.radio("10 - Atualmente como estão sendo aplicados os seus recursos financeiros?",
